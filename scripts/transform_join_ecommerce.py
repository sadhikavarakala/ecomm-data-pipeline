...
if __name__ == "__main__":
    ...
    products_table = f"silken-forest-466023-a2.retail_data.products"
    orders_table   = f"silken-forest-466023-a2.retail_data.orders"
    output_table   = f"silken-forest-466023-a2.retail_data.enriched_orders"

    #Temporary GCS path for biqquery connector
    bigquery_temp_dir = f"gs://sadhika-temp-bucket/bq_temp"
    ...
    #4. Tranform orders: add total_price = price later after join, but extract order_dt
